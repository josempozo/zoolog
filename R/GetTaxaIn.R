#' Taxa included in a taxonomical category
#'
#' Function to obtain the set of taxa included in a particular taxonomical
#' group according to the \code{\link{zoologTaxonomy}}.
#'
#' @param groupName A name of any of the taxonomical groups at any level from
#' taxon to family.
#'
#' @return
#' A character vector including the taxa included in the requested
#' \code{groupName}.
#'
#' @examples
...
#' @export
GetTaxaIn <- function(groupName)
{
  as.character(
    zoologTaxonomy$Taxon[as.logical(rowSums(zoologTaxonomy == groupName))])
}
