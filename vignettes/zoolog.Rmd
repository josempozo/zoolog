...
[**ActiveLanguages**](../help/ActiveLanguages)
  : This includes functions to get the inventory of available languages (`AllAvailableLanguages`) for the thesaurus and to get and set the active languages (`GetActiveLanguages` and `SetActiveLanguages`).
