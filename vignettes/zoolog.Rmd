...
A [taxonomy](../help/zoologTaxonomy) for the most typical zooarchaeological taxa has been introduced in the *zoolog* major release 1.0.0. The taxonomic hierarchy is structured up to the class level:
``` {r, echo=FALSE}
...
[**Thesaurus management**](../help/ThesaurusManagement)
  : This includes functions to modify and check thesauri:
    ...
    * `RemoveRepeatedNames` cleans a thesarus from any repeated terms on any 
      category.
