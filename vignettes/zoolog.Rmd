...
author: "Jose M Pozo, Silvia Valenzuela-Lamas, Ariadna Nieto-Espinet, Angela Trentacoste and Silvia Guimarães Chiarelli"
...
ggsave(file.path(outFolder,"ExampleBoxplotCaprineWidths.pdf"))
...
ggsave(file.path(outFolder,"ExampleBoxplotCaprineLengths.pdf"))


########### Histograms Caprines Widths
pdf(file = file.path(outFolder,"ExampleHistogramCaprineWidths.pdf"),
    width = 15, height = 8)
...
pdf(file = file.path(outFolder,"ExampleHistogramCaprineLengths.pdf"),
    width = 15, height = 8)
